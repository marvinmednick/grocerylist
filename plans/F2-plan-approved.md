...
<!-- Approved — ready to implement: ./implement F2 --plan-approved -->
...
- `client/components/MultiTripModal.tsx` — presentational modal component with props:
  ...
  Required structure (ui-guidelines §7):
  ```tsx
...
- `client/api/__tests__/list-f2-test.tsx` — tests:
...
- `client/api/__tests__/profile-f2-test.tsx` — tests:
