...
>
> **Input & vocabulary feature chain:** F44 → F79 → F77/F83 → F78/F76. See [vocabulary-and-quantity-architecture.md](docs/design/vocabulary-and-quantity-architecture.md) for dependencies and rationale.
