...
| F78 | Duplicate Entry Handling | Done | [specs/F78-duplicate-entry-handling.md](specs/F78-duplicate-entry-handling.md) · [design](docs/design/F78-duplicate-entry-handling.md) | [#78](https://github.com/marvinmednick/grocerylist/issues/78) |
...
| F81 | Dark Mode Visual Implementation | In Review | [specs/F81-dark-mode.md](specs/F81-dark-mode.md) · [design](docs/design/F81-dark-mode.md) | [#81](https://github.com/marvinmednick/grocerylist/issues/81) |
...
| F107 | Warning Recompute on Entry Store Change | Done | — | [#107](https://github.com/marvinmednick/grocerylist/issues/107) |
| F108 | Add New as Inline Duplicate Option | Done | [specs/F108-add-new-inline-option.md](specs/F108-add-new-inline-option.md) · [design](docs/design/F108-add-new-inline-option.md) | [#108](https://github.com/marvinmednick/grocerylist/issues/108) |
