...
Once the spec content is complete, derive a short kebab-case slug from the feature name (e.g. "list-interactions", "duplicate-detection") and write the full spec to `specs/[slug].md` using the Write tool. Begin the file with:
```
# Spec: [Feature Name]
